...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("forecast_years", sa.Integer(), nullable=False, server_default="5"),
        ...
        sa.Column("terminal_method", sa.String(20), nullable=False, server_default="gordon_growth"),
        ...
        sa.Column("net_debt", sa.Float(), nullable=False, server_default="0"),
    ...
    op.create_table(
        ...
        sa.Column("is_outlier", sa.String(10), nullable=False, server_default="false"),
    ...
    op.create_table(
        ...
        sa.Column("is_public_target", sa.String(10), nullable=False, server_default="false"),
        sa.Column("is_stale", sa.String(10), nullable=False, server_default="false"),
        sa.Column("weight", sa.Float(), nullable=False, server_default="1"),
        sa.Column("notes", sa.Text(), nullable=True),
        sa.Column("created_at", sa.DateTime(timezone=True), server_default=sa.func.now(), nullable=False),
        sa.Column("updated_at", sa.DateTime(timezone=True), nullable=True),
