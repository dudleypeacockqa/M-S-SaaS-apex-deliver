...
def upgrade() -> None:
    ...
    # Always use VARCHAR(36) for user foreign keys (matching model definition)
    ...
    sa.Column('follower_user_id', GUID(), nullable=False),
    sa.Column('following_user_id', GUID(), nullable=False),
    ...
    sa.Column('moderator_user_id', GUID(), nullable=False),
    ...
    sa.Column('organization_id', sa.String(length=36), nullable=False),
    sa.Column('registered_by_user_id', GUID(), nullable=True),
    sa.Column('created_at', sa.DateTime(timezone=True), nullable=True),
    sa.Column('updated_at', sa.DateTime(timezone=True), nullable=True),
    sa.ForeignKeyConstraint(['event_id'], ['events.id'], ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['organization_id'], ['organizations.id'], ),
