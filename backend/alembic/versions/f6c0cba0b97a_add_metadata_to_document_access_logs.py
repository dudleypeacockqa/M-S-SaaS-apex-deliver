...
Note: This migration was previously missing but is referenced by other migrations.
The metadata_json column functionality may have been handled by other migrations,
so this is a stub migration to maintain migration chain integrity.
"""
