...
@router.post("/documents", response_model=DocumentMetadata, status_code=status.HTTP_201_CREATED)
...
def delete_document(
    ...
    document_service.archive_document(document=document, db=db)
...
def restore_document_endpoint(
    ...
    document_service.restore_document(document=document, db=db)
