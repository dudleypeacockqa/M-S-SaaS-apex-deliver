...
class TestPodcastFeatureAccessEndpoint:
    ...
    def test_feature_access_returns_true_for_authorized_tier(self, client,
        dependency_overrides,
    ) -> None:
        ...
        mock_required.assert_called_with("podcast_audio")def test_feature_access_returns_false_for_insufficient_tier(self, client,
        dependency_overrides,
    ) -> None:
        organization_id = "org_starter"
        starter_user = SimpleNamespace(
    ...
    def test_feature_access_returns_404_for_unknown_feature(self, client,
        dependency_overrides,
    ) -> None:
        organization_id = "org_pro"
        professional_user = SimpleNamespace(
        ...
        assert "Feature not found" in response.json()["detail"]class TestPodcastListEndpoint:
...
class TestTranscription:
    ...
    ,
        ...
        dependency_overrides(get_current_user, lambda: enterprise_user)
        with patch(
            "app.api.dependencies.auth.check_feature_access",
            new_callable=AsyncMock,
        ) as mock_feature, patch(
