...
describe("Podcast Studio Transcript Panel", () => {
  it("renders transcribe action when no transcript exists", async () => {
  ...
  it("shows transcript metadata, download links, and regenerate action", async () => {
    ...
    expect(screen.getByText(/existing transcript text/i)).toBeInTheDocument()
