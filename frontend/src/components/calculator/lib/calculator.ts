// Calculator utility functions for working capital analysis
...
// Get industry benchmark (simplified version)
function getIndustryBenchmark(industry: string): number {
  const benchmarks: Record<string, number> = {
    manufacturing: 120000,
    wholesale: 150000,
    professional_services: 180000,
    construction: 100000,
    tech: 200000,
  };
  
  return benchmarks[industry] || 150000;
}
