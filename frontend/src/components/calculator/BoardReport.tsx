...
// Use FinanceFlo logo PNG for better rendering
  const logoImg = `<img src="/assets/branding/financeflo-logo-primary.png" alt="FinanceFlo" style="height:42px;width:auto;display:block" />`;
