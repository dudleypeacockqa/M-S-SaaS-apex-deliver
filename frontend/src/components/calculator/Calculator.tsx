...
import { compute, type CalculatorInputs, type CalculatorResults } from './lib/calculator';
import { track, trackCalculatorView } from './lib/analytics';
...
export const Calculator: React.FC<CalculatorProps> = ({ debounceMs = 200 }) => {
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8" data-testid="calculator">
      ...
      <Card className="h-fit">
        <div className="p-6">
          <h2 className="text-2xl font-semibold text-navy mb-6">Your Business Details</h2>
          ...
          <div className="border rounded-lg p-4 mb-6">
            <details className="group">
              <summary className="flex cursor-pointer items-center justify-between font-medium text-navy hover:text-blue">
              ...
              <div className="pt-4 group-open:animate-fadeIn">
                <div className="space-y-6 pt-4">
                  ...
                  <div className="border-t pt-4">
                    <h4 className="text-lg font-medium text-navy mb-4">Working Capital Levers</h4>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
          ...
          {results ? (
            <div className="space-y-8 py-12">
              ...
              <div className="bg-white rounded-2xl shadow-md border border-slate-200 p-6">
                <h3 className="text-xl font-semibold text-navy mb-6">Cash Coverage</h3>
              ...
              <div className="bg-white rounded-2xl shadow-md border border-slate-200 p-6">
                <h3 className="text-xl font-semibold text-navy mb-6">Cash Injection Needed</h3>
              ...
              <div className="bg-white rounded-2xl shadow-md border border-slate-200 p-6">
                <h3 className="text-xl font-semibold text-navy mb-6">Estimated Cash Unlock</h3>
                <div className="space-y-3">
                  <div className="flex justify-between items-center">
              ...
              <div className="bg-white rounded-2xl shadow-md border border-slate-200 p-6">
                <div className="flex items-center justify-between mb-4">
                  <h3 className="text-xl font-semibold text-navy">Revenue per Employee</h3>
                  <div className="flex items-center">
                    ...
                    <span className={`text-sm font-medium ${
                      results.benchmarkDelta > 0 ? 'text-emerald-600' : 
                ...
                <div className="text-2xl font-bold text-navy mb-1" data-testid="rpe-value">
              ...
              {results.talkingPoints.length > 0 && (
                <div className="bg-white rounded-2xl shadow-md border border-slate-200 p-6">
                  <h3 className="text-xl font-semibold text-navy mb-6">Board-Ready Talking Points</h3>
              ...
              {/* Download Report */}
              <div className="bg-white rounded-2xl shadow-md border border-slate-200 p-6">
                <h3 className="text-xl font-semibold text-navy mb-6">Download Results</h3>
                <p className="text-sm text-gray-600 mb-4">
                  Export your calculator results for sharing or further analysis.
                </p>
                <DownloadReport results={results} inputs={inputs} />
              </div>
            </div>
          ) : (
      ...
      {/* Mobile Sticky Bar */}
      <div className="lg:hidden fixed bottom-0 inset-x-0 bg-white border-t border-gray-200 p-4 shadow-lg z-50">
        <Button 
