        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="space-y-8 sm:space-y-10">
            ...
            <div className="inline-flex items-center px-4 py-2 bg-white/10 backdrop-blur-sm rounded-full border border-white/20">
              <CheckCircle className="h-4 w-4 text-brand-teal-600 mr-2" />
            ...
            <div className="space-y-4 sm:space-y-6">
              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold leading-tight font-heading">
                ...
                <br />
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-teal-600 to-brand-teal-400">
                  Finance Operations
                </span>
                <br />
              ...
              <p className="text-base sm:text-lg lg:text-xl text-white/90 leading-relaxed max-w-2xl font-body">
                ...
                Join 450+ businesses achieving <span className="text-brand-teal-600 font-semibold">66% cost reduction</span> and
                <span className="text-brand-teal-600 font-semibold"> 500% ROI boost</span> with our Adaptive Intelligence Framework™.
              </p>
            </div>
            ...
            <div className="grid grid-cols-3 gap-4 sm:gap-6">
              ...
              <div className="bg-white/15 backdrop-blur-sm rounded-xl p-4 sm:p-6 border border-white/30 text-center hover:bg-white/20 transition-all duration-300">
                <div className="text-2xl sm:text-3xl lg:text-4xl font-bold text-brand-teal-600 mb-2 sm:mb-3">66%</div>
                <div className="text-white/90 text-xs sm:text-sm font-medium">Cost Reduction</div>
              </div>
              <div className="bg-white/15 backdrop-blur-sm rounded-xl p-4 sm:p-6 border border-white/30 text-center hover:bg-white/20 transition-all duration-300">
                <div className="text-2xl sm:text-3xl lg:text-4xl font-bold text-brand-teal-600 mb-2 sm:mb-3">500%</div>
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
              <Button
                ...
                className="bg-gradient-to-r from-brand-teal-600 to-brand-teal-400 hover:from-brand-teal-700 hover:to-brand-teal-600 text-white font-semibold px-6 sm:px-8 py-3 sm:py-4 rounded-lg text-base sm:text-lg transition-all duration-300 shadow-lg hover:shadow-xl w-full sm:w-auto"
              >
            ...
            <div className="flex flex-wrap items-center gap-4 sm:gap-6 pt-4 sm:pt-6">
              <div className="flex items-center space-x-2 text-white/90">
                <CheckCircle className="h-4 w-4 sm:h-5 sm:w-5 text-brand-teal-600" />
            ...
            <div className="bg-white/95 backdrop-blur-sm rounded-2xl sm:rounded-3xl shadow-2xl border border-white/20 overflow-hidden">
              ...
              <div className="p-6 bg-gradient-to-br from-[#F4F6F8] to-white">
                ...
                <div className="text-center mb-6">
                  <Button className="bg-brand-teal-600 text-white hover:bg-brand-teal-700 shadow-md">
                ...
                <div className="flex justify-between items-center mb-4">
                  ...
                  <div className="bg-brand-teal-600/10 text-brand-teal-600 text-xs px-2 py-1 rounded-full font-medium">
                    Real-time Alerts
                  </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-4 mb-6">
                  <div className="bg-white rounded-lg p-4 shadow-sm border-l-4 border-brand-teal-600">
                    ...
                    <div className="flex items-baseline">
                      <span className="text-2xl font-bold text-brand-teal-600">£2.4M</span>
                      <span className="text-brand-teal-600 text-sm ml-2 bg-brand-teal-600/10 px-2 py-1 rounded">+23% vs last month</span>
                    </div>
                ...
                <div className="bg-white rounded-lg p-4 shadow-sm mb-4">
                  ...
                  <div className="flex items-end justify-between space-x-1 h-32 bg-gradient-to-t from-[#F4F6F8] to-transparent rounded-lg p-2">
                    ...
                    <div className="group relative">
                      <div className="bg-gradient-to-t from-brand-teal-600 to-brand-teal-400 w-6 h-20 rounded-t-md shadow-lg transition-all duration-500 hover:scale-110 animate-pulse"></div>
                      <div className="absolute -top-8 left-1/2 transform -translate-x-1/2 bg-gray-800 text-white text-xs px-2 py-1 rounded opacity-0 group-hover:opacity-100 transition-opacity">
                        £2.4M
                      </div>
                    </div>
                    ...
                    <div className="group relative">
                      <div className="bg-gradient-to-t from-brand-teal-600 to-brand-teal-400 w-6 h-26 rounded-t-md shadow-lg transition-all duration-500 hover:scale-110"></div>
                      <div className="absolute -top-8 left-1/2 transform -translate-x-1/2 bg-gray-800 text-white text-xs px-2 py-1 rounded opacity-0 group-hover:opacity-100 transition-opacity">
                        £2.7M
                      </div>
                    </div>
                  ...
                  <div className="mt-2 text-center">
                    <span className="bg-gradient-to-r from-brand-teal-600/10 to-brand-blue/10 text-brand-teal-600 text-xs px-3 py-1 rounded-full border border-brand-teal-600/20">💰 Working Capital Optimization</span>
                  </div>
                </div>
              </div>
            </div>
