...
export const PricingCard: React.FC<PricingCardProps> = ({
  ...
  const buttonClasses = highlighted
    ? 'w-full bg-indigo-900 text-white px-6 py-3 rounded-lg font-bold hover:bg-indigo-800 transition-colors'
    : 'w-full bg-gray-100 text-indigo-900 border-2 border-indigo-900 px-6 py-3 rounded-lg font-semibold hover:bg-gray-200 transition-colors';
