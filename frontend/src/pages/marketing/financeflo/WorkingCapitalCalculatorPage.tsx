      ...
      <div className="min-h-screen bg-brand-grey py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-12">
            <div className="mb-4">
              <span className="inline-block bg-brand-teal-600/10 text-brand-teal-600 text-sm font-semibold px-4 py-2 rounded-full">
                Trusted by 450+ CFOs
              </span>
            </div>
            ...
            <div className="flex items-center justify-center gap-6 text-sm text-gray-600">
              <div className="flex items-center gap-2">
                <svg className="w-5 h-5 text-brand-teal-600" fill="currentColor" viewBox="0 0 20 20">
