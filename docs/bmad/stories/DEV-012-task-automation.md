...
- Extended subscription edge-case suite (`backend/tests/test_subscription_service_edge_cases.py`) to cover invalid tiers, Stripe customer reuse, custom URLs, cancellation proration, and default proration behaviour—lifting module coverage above the 85% target.
